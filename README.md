...
TOKEN = "8549135637:AAE7AxpOMonSM-ivbBvKIYJMt5M8dFIuVfM"
...
def vazifa(msg):
    ...
    if now - last < 300:
        bot.send_message(msg.chat.id,
            "⏳ Iltimos 5-10 daqiqadan keyin yangi kanalar ochiladi hozircha kiravering")
        return
    ...
    bot.send_message(msg.chat.id,
        "Salom balans ishlash uchun ushbu kanalga obuna bo‘ling va 5 balans oling",
        reply_markup=kb)
...
def check(call):
    ...
    if status in ["member","administrator","creator"]:
        ...
        bot.send_message(call.message.chat.id,
            "🎉 5 balans oldingiz!\n\n⏳ Keyingi vazifa 5-10 daqiqadan keyin")
    else:
...
def referal(msg):
    ...
    bot.send_message(msg.chat.id,
        f"👥 Referal linkingiz:\n{link}\n\n"
        f"Har bir odam uchun 10 balans olasiz")
...
def ai(msg):
    ...
    bot.send_message(msg.chat.id, "📸 Iltimos Minecraft skiningizni tashlang")
...
def admin(msg):
    ...
    bot.send_message(msg.chat.id, "Admin panel ishlayapti ⚙️")
